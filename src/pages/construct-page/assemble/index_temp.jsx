        ...
        <>
             <Card title="主题分面树" style={treeStyle}>
                {
                    showSpiderState ? (
                        !pauseSpider ? (
                            <>
                            <button class="ant-btn ant-btn-ghost ant-btn-sm" onClick={showDrawer} style={{ position: "absolute", right: '5%', top: "15%", width: "100px", height: "28px", }}>
                                    展开爬虫小组件
                            </button>
                                <Drawer
                                    title={"爬虫控制小组件"}
                                ...
                                >
                                    ...
                                    <button class="ant-btn ant-btn-ghost ant-btn-sm" onClick={onPauseSpider} style={{ position: "absolute", right: '25%', top: "46%", width: "30px", height: "22px", }}>
                                        <PauseOutlined />
                                    </button>
                                    <div style={{ fontSize: "18px", fontWeight: "bold", marginTop: "6%", textAlign: 'left' }}><span style={{ color: "#979693", }}>停止爬取按钮</span></div>
                                    <button class="ant-btn ant-btn-ghost ant-btn-sm" onClick={onQuitSpider} style={{ position: "absolute", right: '25%', top: "57%", width: "30px", height: "22px", }}>
                                        <StopOutlined />
                                    </button>
                                    <div style={{ fontSize: "18px", fontWeight: "bold", marginTop: "6%", textAlign: 'left' }}><span style={{ color: "#979693", }}>爬取下一主题</span></div>
                                    <button class="ant-btn ant-btn-ghost ant-btn-sm" onClick={onNextSpider} style={{ position: "absolute", right: '25%', top: "68%", width: "30px", height: "22px", }}>
                                        <CaretRightOutlined />
                                    </button>
                                </Drawer>
                            </>
                            ...
                            (
                                <>
                                    ...
                                    >
                                        ...
                                        <button class="ant-btn ant-btn-ghost ant-btn-sm" onClick={onPlaySpider} style={{ position: "absolute", right: '25%', top: "46%", width: "30px", height: "22px", }}>
                                            <CaretRightOutlined />
                                        </button>
                                        <div style={{ fontSize: "18px", fontWeight: "bold", marginTop: "6%", textAlign: 'left' }}><span style={{ color: "#979693", }}>停止爬取按钮</span></div>
                                        <button class="ant-btn ant-btn-ghost ant-btn-sm" onClick={onQuitSpider} style={{ position: "absolute", right: '25%', top: "57%", width: "30px", height: "22px", }}>
            ...
            <Card title="碎片状态展示" style={chartStyle}>
                ...
                {/* <div style={{textAlign:"center",height:"100px"}}>
                    <div style={{position: 'relative', width:"160px", left:"0%", textAlign:"center", top:"10px"}}>
                    <span style={{fontSize:"18px"}}><br/>{currentTopic}</span>
                    </div>
                    <div style={{position: 'relative', width:"200px", marginLeft:"20px"}}>
                    ...
                    finishedTopic ? (
                        finishedTopic.map(
                            (topic) => (
                                ...
                                {/* <div style={{textAlign:"center",height:"100px"}}>
                                <div style={{ position: 'relative', width:"160px",left:"0%",textAlign:"center",top:"10px"}}>
                                <span style={{fontSize:"18px"}}>{topic.topicName}</span>
                                </div>
                                <div style={{position: 'relative', width:"200px", marginLeft:"20px"}}>
                    ...
                    unfinishedTopic ? (
                        unfinishedTopic.map(
                            (topic) => (
                                ...
                                {/* <div style={{textAlign:"center",height:"100px"}}>
                                <div style={{width:"140px",left:"0%",textAlign:"center",top:"200px"}}>
                                <span style={{fontSize:"18px"}}>{topic.topicName}</span>
                                </div>
